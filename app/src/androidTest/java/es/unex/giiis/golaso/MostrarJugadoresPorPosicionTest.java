...
public class MostrarJugadoresPorPosicionTest {
    ...
    @Test
    public void mostrarJugadoresPorPosicionTest() throws InterruptedException {
        ...
        ViewInteraction switchMaterial = onView(
                allOf(withId(R.id.switch1), withText("Mostrar por posición"),
                        childAtPosition(
                                childAtPosition(
