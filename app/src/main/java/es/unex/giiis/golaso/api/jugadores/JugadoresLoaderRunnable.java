...
public class JugadoresLoaderRunnable implements Runnable{

    private final InputStream mInFile;
    private final OnJugadoresLoadedListener mOnJugadoresLoadedListener;

    public JugadoresLoaderRunnable(InputStream inFile, OnJugadoresLoadedListener
            onJugadoresLoadedListener){
