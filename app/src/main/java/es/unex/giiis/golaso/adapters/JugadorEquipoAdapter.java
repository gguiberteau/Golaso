...
public class JugadorEquipoAdapter extends RecyclerView.Adapter<JugadorEquipoAdapter.ViewHolder>{
    ...
    private JugadorEquipoAdapter.ItemClickListener clickListener;

    public JugadorEquipoAdapter(Context context, List<Jugador> responseList, int idEquipo, SwitchCompat mSwitch, JugadorEquipoAdapter.ItemClickListener clickListener) {
